...
function() {
    ...
    function e() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e]; (n = console.warn || console.log).call.apply(n, [console, "[ROCKET LOADER] "].concat(t));
        var n
    }
    function n(t, e) {
        var n = e.parentNode;
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?899886c4dfcd8dc1d155d15db93ce634";
